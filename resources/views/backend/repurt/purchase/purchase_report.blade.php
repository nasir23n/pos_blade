...
<div class="card">
    ...
    <form action="{{ route('admin.reports.purchase.filter') }}" id="report_form" method="GET">
       @csrf
       <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label class="input-group mb-3">
                            <input type="text" name="start_date" class="form-control datepicker_fld" placeholder="Start Date">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="input-group mb-3">
                            <input type="text" name="end_date" class="form-control datepicker_fld" placeholder="End Date">
                            <span class="input-group-text"><i class="far fa-clock"></i></span>
                        </label>
                    </div>
                </div>
...
$('#report_form').submit(function(e) {
    ...
    $.ajax({
        type : 'GET',
        url : `{{ route('admin.reports.purchase.filter') }}`,
