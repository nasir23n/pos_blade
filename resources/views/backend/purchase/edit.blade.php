            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" name="date" class="form-control" form="purchase_form" value="{{ \Carbon\Carbon::parse($purchase->date)->format('Y-m-d') }}" id="date" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="purchase_status" class="form-select" form="purchase_form" id="purchase_status" required>
                            <option value="Painding" {{ ($purchase->purchase_status == 'Painding') ? 'selected' : '' }}>Painding</option>
                            <option value="Received" {{ ($purchase->purchase_status == 'Received') ? 'selected' : '' }}>Received</option>
                            <option value="Complete" {{ ($purchase->purchase_status == 'Complete') ? 'selected' : '' }}>Complete</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" form="purchase_form" class="form-control disabled" value="OD-01" disabled>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody id="selected_items">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="form-control sell_price" form="purchase_form" type="number" name="sell_price[]" value="{{ $item->price_was->sell_price }}" min="0">
                            </td>
                            <td>
                                <input type="number" form="purchase_form" class="form-control purchase_price" name="purchase_price[]" value="{{ $item->price_was->purchase_price }}" min="0">
                            </td>
                            <td>
